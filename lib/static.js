...
var select = require('cheerio-select'),
    ...
    fApply = Function.prototype.apply;
...
var load = exports.load = function(str, options) {
  var Cheerio = require('./cheerio'),
      ...
      Context = function() {
        // The Cheerio function does not inherit from Function, so use a static
        // reference to `Function.prototype.apply`.
        return fApply.call(Cheerio, this, arguments);
      };
  Context.prototype = Object.create(Cheerio.prototype);
  Context.prototype.constructor = Context;

  // Overwrite default options if custom options are present
  if (typeof options === 'object') {
    Context.prototype.options = options;
  }

  var initialize = function(selector, context, r) {
    return new Context(selector, context, r || root);
  };
