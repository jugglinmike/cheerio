...
var add = exports.add = function(selector, context) {
  var set = typeof selector === 'string' ?
    new cheerio(selector, context || this._root) :
    this.make(selector && selector.name ?
      Array.prototype.slice.call(arguments) : selector.toArray());

  Array.prototype.push.apply(set, this);
