  ...
  return function() {
    ...
    return domEach(this, function(i, el) {
      ...
      if (typeof elems[0] === 'function') {
        domSrc = elems[0].call(el, i, render.html(el.children));
      } else {
        domSrc = elems;
      }
...
exports.html = function(str) {
  if (str === undefined) {
    ...
    return render.html(this[0].children, this.options);
  }
...
exports.toString = function() {
  return render.html(this, this.options);
};
