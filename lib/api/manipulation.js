  ...
  return function() {
    ...
    return domEach(this, function(i, el) {
      ...
      if (typeof elems[0] === 'function') {
        domSrc = elems[0].call(el, i, staticMethods.html(el.children));
      } else {
        domSrc = elems;
      }
...
exports.html = function(str) {
  if (str === undefined) {
    ...
    return staticMethods.html(this[0].children, this.options);
  }
...
exports.toString = function() {
  return staticMethods.html(this, this.options);
};
...
exports.text = function(str) {
  ...
  if (str === undefined) {
    return staticMethods.text(this);
  } else if (typeof str === 'function') {
    // Function support
    var self = this;
    return domEach(this, function(i, el) {
      return exports.text.call(self._make(el), str.call(el, i, staticMethods.text([el])));
    });
  }
