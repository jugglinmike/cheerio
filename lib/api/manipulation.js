  ...
  return function() {
    ...
    return domEach(this, function(i, el) {
      ...
      if (typeof elems[0] === 'function') {
        domSrc = elems[0].call(el, i, this.constructor.html(el.children));
      } else {
        domSrc = elems;
      }
...
exports.html = function(str) {
  if (str === undefined) {
    ...
    return this.constructor.html(this[0].children, this.options);
  }
...
exports.toString = function() {
  return this.constructor.html(this, this.options);
};
  ...
  if (str === undefined) {
    ...
    return domEach(this, function(i, el) {
      return exports.text.call(
        self._make(el),
        str.call(el, i, this.constructor.text([el]))
      );
    });
  }
